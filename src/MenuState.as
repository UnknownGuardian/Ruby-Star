package  
{
	...
	public class MenuState extends GameState
	{
		...
		public var more:Sprite = new Sprite();
		...
		public function MenuState() 
		{
			...
			main.addChild(createLayOver(189, 229, 266, 35, gotoGameFromMain));
			main.addChild(createLayOver(189, 286, 266, 35, gotoOptionsFromMain));
			main.addChild(createLayOver(189, 344, 266, 35, gotoCreditsFromMain));
			main.addChild(createLayOver(189, 404, 266, 35, gotoMoreFromMain));
