	...
	public class PlayState extends GameState
	{
		...
		*/
		...
		public function createItemGrid():void
		{
			...
			var b:ScrollingBackground = ScrollingBackground(Layers.Background);
			for (var k:int = 40; k < b.WIDTH - 30; k += 30)
			{
				for (var j:int = 65; j < b.HEIGHT - 30; j += 30)
				{
		...
		public function spawnEnemies():void
		{
			...
			if (level >= 4)
			{
				...
				if (enemyCounter > enemyLimit)
				{
					...
					e.x = Math.random() < 0.5 ? 10 : ScrollingBackground(Layers.Background).WIDTH;
					e.y = ScrollingBackground(Layers.Background).HEIGHT / 2;
